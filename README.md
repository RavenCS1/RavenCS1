...
- **Nordic Semiconductors** — nRF wireless SoCs, embedded BLE
- **STM32** — ARM Cortex-M microcontrollers, bare-metal & RTOS
...
# Student Clubs
**Computer Science Students Club "Kernel"** · [GitHub](https://github.com/kni-kernel)  
_Faculty of Physics and Applied Computer Science_  
**Board Member** · Led beginner and advanced supplementary C language tutorials for fellow students

**KN Hardwire AGH** · [GitHub](https://github.com/KN-Hardwire)  
_Faculty of Electrical Engineering, Automatics, IT & Biomedical Engineering_  
Hardware design & electronics projects

**AGH Skylink** · [GitHub](https://github.com/AGH-Skylink/)  
