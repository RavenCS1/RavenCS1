...
**Passions**: low-level C programming, IOCCC contests, reverse engineering, computer architecture.  
**Focus**: crafting efficient, optimized code and unconventional programming challenges.  

Currently learning C++ with plans to master Rust.  
